...
class GroverSingle3storeClass(val n: Int) extends Quantum(2*n) {
  ...
  SimpleAPI.withProver(enableAssert = debug, otherSettings = settings) { p => import p._
    ...
    val temp3 = createConstant(arrayN.sort)
    ...
    scope {
        ...
        //////////////////////////
        ?? (states.last === arraySto(con(bools(6), complex(0, 0, 0, 0, 17)), (5, True) ->
...
object GroverSingle3store {
    def main(args: Array[String]): Unit = {
        new GroverSingle3storeClass(3).main(args)
    }
}